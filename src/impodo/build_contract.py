...
from .adapters.duckdb.constants import SCHEMA_GENERATION, SCHEMA_VERSION
from .migration_foundation import require_hash
...
def calculate_application_build_contract() -> ApplicationBuildContract:
    ...
    return ApplicationBuildContract(
        ...
        workspace_schema_generation=SCHEMA_GENERATION,
